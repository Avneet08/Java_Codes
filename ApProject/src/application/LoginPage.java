...
Statement s=null;
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException, SQLException {                                       
        // TODO add your handling code here:
    ...
    String Password= String.valueOf(password1.getText());
        ...
        //s.executeQuery ("SELECT *  FROM firstschema78.login");
        
      //conn=ApProject.Connect.ConnectDB();
      ...
      try
      {
          ...
          if (rs.next()){
             ...
             if(post.equals("Student")){
                ...
                FacultyLogin frm1=new FacultyLogin();
                frm1.setVisible(true);
                System.out.println("FAC");
             }
             else if(post.equals("Admin")){
                AdminLogin frm3=new AdminLogin();
